...
def draw(players, camps, goals, animations, world, screen, clock):
  # clear screen
  ...
  draw_information(players, Vector(10,10), world, screen, clock)
...
def draw_information(players, pos, world, screen, clock):
  global name_images
  global font
